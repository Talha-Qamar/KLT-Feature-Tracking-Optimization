/*
 * klt_timing.h - Comprehensive timing infrastructure for KLT tracker (V2 - GPU)
 *
 ...
 * 4. Data Transfer - Time spent transferring data to/from GPU
 * 5. Total Execution - Overall runtime including I/O and initialization
 *
 * Usage:
 *   #include "klt_timing.h"
 *   
 *   KLT_TimingContext timing = KLT_CreateTimingContext();
 *   
 ...
 *   
 *   KLT_PrintTimingResults(timing, "V2 - GPU Implementation");
...
static inline KLT_TimingContext KLT_CreateTimingContext(void) {
    ...
    tc->timer_names[KLT_TIMER_MEMORY_OPS] = "GPU Memory Ops";
